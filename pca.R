...
par(mfrow=c(2,3))
plot(res_pc1, main = "Residuos PC1", xlab="Observación", ylab="Residuo")
qqnorm(res_pc1, main = "QQ Residuos PC1", xlab="Cuantiles Normales", ylab="Cuantiles Residuos")
qqline(res_pc1)
hist(res_pc1, main="Distribución de residuos PC1", xlab="Residuos", ylab="Frecuencia")
plot(res_pc2, main = "Residuos PC2", xlab="Observación", ylab="Residuo")
qqnorm(res_pc2, main = "QQ Residuos PC2", xlab="Cuantiles Normales", ylab="Cuantiles Residuos")
qqline(res_pc2)
hist(res_pc2, main="Distribución de residuos PC2", xlab="Residuos", ylab="Frecuencia")
#dev.off()
# Gŕaficos----------------------------------------------------------------------
